...
# 40 m range cap: spec §3.6, derived for the Mid-360's 10 %-reflectivity range,
#   NOT validated on this substrate. The 40 m+ bin exists only for the
#   accumulated-cloud side track and is kept separate.
